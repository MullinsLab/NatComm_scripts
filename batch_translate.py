...
"""
translate NT alignments into AA alignments ()
modified by Wenjie Deng to allow user define input and output directiory
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--inputdir", help="directory to hold input sequence fasta file", nargs="?", const=1, type=str, default=".")
    parser.add_argument("-o", "--outputdir", help="number of processes for multiprocessing", nargs="?", const=1, type=str,
                        default="AA_alignments")
